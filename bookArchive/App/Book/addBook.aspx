<%@ Page Title="" Language="C#" MasterPageFile="~/App/MasterPages/Foundation.Master" AutoEventWireup="true" CodeBehind="addBook.aspx.cs" Inherits="bookArchive.App.Book.addBook" %>
        ...
        <div class="twelve columns">
            <table width="100%">
                ...
                <tr>
                    <td><b>Index:</b></td>
                    <td>
                        <asp:TextBox ID="txtIndex" runat="server" TextMode="MultiLine" Height="146px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><b>Notlar:</b></td>
                    <td>
                        <asp:TextBox ID="txtNotes" runat="server" TextMode="MultiLine" Height="284px"></asp:TextBox></td>
                </tr>
                <tr>
